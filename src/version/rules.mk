...
VERSION_FLAGS  =
VERSION_FLAGS += $(shell if test x$(VERSION_REVDESC) != "x"; then echo "-DPHAETHON_REVDESC=\\\"$(VERSION_REVDESC)\\\""; fi)
VERSION_FLAGS += $(shell if test x$(VERSION_REV) != "x"; then echo "-DPHAETHON_REV=\\\"$(VERSION_REV)\\\""; fi)
VERSION_FLAGS += $(shell if test x$(VERSION_DATE) != "x"; then echo "-DPHAETHON_BUILDDATE=\\\"$(VERSION_DATE)\\\""; fi)
