...
/** @file
 *  Unit tests for ISO-8859-15 (Latin-9) encoding functions.
 */
...
#define XOREOS_ENCODINGNAME EncodingLatin9
static const Common::Encoding kEncoding = Common::kEncodingLatin9;
