...
/** @file
 *  Unit tests for Windows codepage 1252 encoding functions.
 */
...
#define XOREOS_ENCODINGNAME EncodingCP1252
static const Common::Encoding kEncoding = Common::kEncodingCP1252;
...
static const byte stringData0    [] = { 'F', 0xF6, 0xF6, 'b', 0xE4, 'r', '\0', };
// Example string with terminating 0 and garbage following
static const byte stringData0X   [] = { 'F', 0xF6, 0xF6, 'b', 0xE4, 'r', '\0', 'x' };
// Example string without terminating 0 and with garbage following
static const byte stringDataX    [] = { 'F', 0xF6, 0xF6, 'b', 0xE4, 'r', 'x' };
// Example string with line end and garbage following
static const byte stringDataLineX[] = { 'F', 0xF6, 0xF6, 'b', 0xE4, 'r', '\r', '\n', 'x' };
